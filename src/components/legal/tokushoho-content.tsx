          ...
          <tbody>
            ...
            <tr className="border-b border-border align-top">
              ...
              <td className="py-3">
                ...
                <br />
                登録完了までの間、当社は適格請求書発行事業者ではないため、課税事業者であるユーザーは仕入税額控除（経過措置: 2023年10月1日〜2026年9月30日は80%控除可、2026年10月1日〜2029年9月30日は50%控除可、2029年10月1日以降は控除不可）について別途ご確認ください。インボイス対応の請求書発行をご希望の場合は事前にお問い合わせください。
              </td>
            </tr>
            <tr className="border-b border-border align-top">
