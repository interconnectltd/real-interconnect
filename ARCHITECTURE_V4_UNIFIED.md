...
|---|---|---|---|---|
| **P0** | A19 | 特商法ページ | 小 | なし |
| **P0** | A25 | データ保持期間マトリクス | 小 | なし |
| **P0** | A5 | APIレート制限 | 中 | なし |
| **P0** | A11 | 招待機能完成（use_count修正） | 中 | なし |
...
| **P1** | A14 | 検索ソート・フィルタ | 小 | なし |
| **P1** | A15 | 推薦ブラックリスト | 小 | なし |
| **P1** | A16 | プロフィール完成度メーター | 小 | なし |
...
| コネクション管理 | 100% | — |
| メンバー検索 | 90% | A14(ソート/フィルタ)、A18(カテゴリ絞込)未対応 |
| tl;dv連携 | 90% | 稼働中 |
